...
<body>
<p><a href="javascript:history.go(0);">刷新</a> </p>
	...
	<f:form modelAttribute="bill">
		<table>
			...
			<tr>
				<td>开始时间<input type="text" id="beginDate"  name="beginDate" readonly="readonly" />
				<td>截止时间<input type="text" id="endDate" name="endDate" readonly="readonly" />
				</td>
			</tr>
			<tr>
				<td>商品类别<f:select path="paytype"   items="${payList}"  itemLabel="typename"       itemValue="id"> </f:select>
				<td>购物方式 <f:select path="goodstpye"   items="${goodsList}"  itemLabel="typename"       itemValue="id"> </f:select>    
				</td>
			</tr>
			<tr><td><input type="button" value="提交" id="from_but" /></td></tr>
		</table>
		</f:form>
	</div>
	<table class="miantable"></table>
	<div></div>
</body>
<script type="text/javascript">
	laydate({
	...
	$(function() {
	  $("#from_but").click(function(){
	    	$.getJSON(page.basePath + "billAction/queryBill.do", {
